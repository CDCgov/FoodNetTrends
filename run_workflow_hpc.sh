...
#   Trends pipeline, optimized for high-performance computing (HPC) environments.
...
#   - Advanced performance tuning options for different scale analyses
...
#   - Access to an HPC environment with sufficient resources
#
